...
$EDITOR resources/pallet_crate/mongodb_crate/meta.edn
$EDITOR doc-src/USAGE.md
git add resources/pallet_crate/mongodb_crate/meta.edn doc-src/USAGE.md doc-src/FOOTER.md \
